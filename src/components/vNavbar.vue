<template>
<div class="container-fluid shadow p-1 mb-3 bg-body rounded">
  <!-- <div class="container-fluid shadow p-1 mb-3 bg-dark rounded"> -->
...
.navbar-brand {
  background-image: url("../assets/Plogo.png");
