<template>
    ...
    <nav class="top-app-bar navbar navbar-expand navbar-dark bg-dark">
      <div class="container-fluid px-4">
          ...
          <!-- Navbar brand-->
          <a class="navbar-brand me-auto" href="#"><div class="text-uppercase font-monospace">Material Admin Pro</div></a>
          <!-- Navbar items-->
                          ...
                          <li>
                              <a class="dropdown-item unread" href="#!">
                                  <div class="dropdown-item-content">
                                      ...
                                      <div class="dropdown-item-content-subtext">Mar 12, 2022 · Juan Babin</div>
                                  </div>
                              </a>
                          </li>
                          <li><hr class="dropdown-divider my-0" /></li>
                          <li>
                              <a class="dropdown-item" href="#!">
                                  <div class="dropdown-item-content">
                                      ...
                                      <div class="dropdown-item-content-subtext">Mar 10, 2022 · Christine Hendersen</div>
                                  </div>
                              </a>
                          </li>
                          <li><hr class="dropdown-divider my-0" /></li>
                          <li>
                              <a class="dropdown-item" href="#!">
                                  <div class="dropdown-item-content">
                                      ...
                                      <div class="dropdown-item-content-subtext">Mar 8, 2022 · Celia J. Knight</div>
                                  </div>
                              </a>
                          </li>
                          <li><hr class="dropdown-divider my-0" /></li>
                          ...
                          <li>
                              <a class="dropdown-item unread" href="#!">
                                  ...
                                  <div class="dropdown-item-content me-2">
                                      ...
                                      <div class="dropdown-item-content-subtext">Mar 12, 2022 · Performance</div>
                                  </div>
                              </a>
                          </li>
                          <li><hr class="dropdown-divider my-0" /></li>
                          <li>
                              <a class="dropdown-item" href="#!">
                                  ...
                                  <div class="dropdown-item-content me-2">
                                      ...
                                      <div class="dropdown-item-content-subtext">Mar 12, 2022 · Coverage</div>
                                  </div>
                              </a>
                          </li>
                          <li><hr class="dropdown-divider my-0" /></li>
                          <li>
                              <a class="dropdown-item" href="#!">
                                  ...
                                  <div class="dropdown-item-content me-2">
                                      ...
                                      <div class="dropdown-item-content-subtext">Mar 8, 2022 · Coverage</div>
                                  </div>
                              </a>
                          </li>
                          <li><hr class="dropdown-divider my-0" /></li>
